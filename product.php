				...
				<div class="product">
					<div class="row">
						...
						<div class="col-md-7">
                            ...
                            <div class="p-quantity" style="margin-bottom: 0px;" >
                                <div class="row">
                                    <?php if(isset($size)): ?>
                                    <div class="col-md-4 mb_20" style="margin-bottom: 10px;" >
                                        <h5><?php echo LANG_VALUE_52; ?> </h5>
							...
							<div class="p-quantity" style="margin-bottom: 16px;">
                            <h5> <?php echo LANG_VALUE_55; ?></h5>
								<input type="number" class="input-text qty" style="text-align: center;"  step="1" min="1" max="" name="p_qty" value="1" title="Qty" size="4" pattern="[0-9]*" inputmode="numeric">
							</div>
                            <div class="share" style="margin-bottom: 10px;" >
                                        <h5 style="    margin-bottom: 0px;" >Status</h5>
                                <?php if($p_qty == 0): ?>
                                <div class="out-of-stock" style="text-align: inherit;" >
                            ...
                            <div class="p-price">
                                <span style="font-size:14px;"><h5><?php echo LANG_VALUE_54; ?></h5></span>
                                <span>
                                    <?php if($p_old_price!=''): ?>
							...
							<div class="btn-cart btn-cart1">
                                <input type="submit" value="<?php echo LANG_VALUE_154; ?>" name="form_add_to_cart" style="background: #24d278;" >
							</div>
                            </form>
