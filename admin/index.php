...
$statement = $pdo->prepare("SELECT * FROM tbl_payment WHERE order_status=?");
...
$statement = $pdo->prepare("SELECT * FROM tbl_payment WHERE order_status=?");
$statement->execute(array('Canceling'));
$total_order_Canceling = $statement->rowCount();

$statement = $pdo->prepare("SELECT * FROM tbl_payment WHERE order_status=?");
$statement->execute(array('Canceled'));
$total_order_Canceled = $statement->rowCount();

$statement = $pdo->prepare("SELECT * FROM tbl_payment WHERE payment_status=? AND shipping_status=?");
$statement->execute(array('Pending','Shipping'));
			...
			<div class="col-lg-3 col-xs-6">
			  ...
			  <div class="col-lg-3 col-xs-6">
				...
				<div class="small-box bg-red">
				  <div class="inner">
					<h3><?php echo $total_order_Canceling; ?></h3>
  
					<p>Canceling Orders</p>
				  </div>
				  <div class="icon">
					<i class="ionicons ion-backspace"></i>
				  </div>
			  ...
			  <div class="col-lg-3 col-xs-6">
				...
				<div class="small-box bg-red">
				  <div class="inner">
					<h3><?php echo $total_order_Canceled; ?></h3>
