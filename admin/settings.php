...
if(isset($_POST['form3'])) {
    ...
    // updating the database
    $statement = $pdo->prepare("UPDATE tbl_settings SET footer_about=?, newsletter_on_off=?, footer_copyright=?, contact_address=?, contact_email=?, contact_phone=?, contact_map_iframe=? WHERE id=1");
    $statement->execute(array($_POST['footer_about'],$_POST['newsletter_on_off'],$_POST['footer_copyright'],$_POST['contact_address'],$_POST['contact_email'],$_POST['contact_phone'],$_POST['contact_map_iframe']));
...
if(isset($_POST['form6_0'])) {
    // updating the database
    $statement = $pdo->prepare("UPDATE tbl_settings SET home_testimonial_on_off=?, home_service_on_off=?,home_featured_product_on_off=?, home_latest_product_on_off=?, home_popular_product_on_off=? WHERE id=1");
    $statement->execute(array($_POST['home_testimonial_on_off'],$_POST['home_service_on_off'],$_POST['home_featured_product_on_off'],$_POST['home_latest_product_on_off'],$_POST['home_popular_product_on_off']));
                        ...
                        <div class="tab-pane" id="tab_3">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Informations </label>
                                        <div class="col-sm-6">
                        ...
                        <div class="tab-pane" id="tab_6">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Contact Section </label>
                                        <div class="col-sm-4">
                            ...
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8"> -->
                                        <input type="hidden" name="newsletter_text" class="form-control" value="<?php echo $newsletter_text; ?>" cols="30" rows="10" style="height: 120px;">
                                        <!-- </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
